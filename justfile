...
test-init-image:
	...
	docker run --rm --name pid --entrypoint pid1 --workdir=/home pid1runner pwd
	docker run --rm --name pid --entrypoint pid1 --env HELLO=WORLD --env=FOO=BYE pid1runner printenv HELLO FOO
